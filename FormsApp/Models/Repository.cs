namespace FormsApp.Models
{
    public class Repository
    {
        ...
        static Repository()
        {
            ...
            _products.Add(new Product { ProductId = 2, Name = "IPhone 15", Price = 45000, IsActive = false, Image = "2.jpg", CategoryId = 1 });
            _products.Add(new Product { ProductId = 3, Name = "IPhone 16", Price = 50000, IsActive = true, Image = "3.jpg", CategoryId = 1 });
            _products.Add(new Product { ProductId = 4, Name = "IPhone 17", Price = 60000, IsActive = false, Image = "4.jpg", CategoryId = 1 });
